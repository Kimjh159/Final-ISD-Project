# Generated by Django 4.2.1 on 2023-06-07 22:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='recommendclass',
            fields=[
                ('rec_num', models.PositiveIntegerField(db_column='rec_num', primary_key=True, serialize=False)),
                ('rec_classtype', models.CharField(db_column='rec_classtype', max_length=6)),
                ('rec_class', models.CharField(db_column='rec_class', max_length=2)),
                ('rec_pro', models.CharField(db_column='rec_pro', max_length=20)),
                ('rec_price', models.PositiveIntegerField(db_column='price per hour')),
                ('rec_weightpl', models.DecimalField(db_column='rec_weightpl', decimal_places=2, max_digits=5)),
                ('rec_weightmi', models.DecimalField(db_column='rec_weightmi', decimal_places=2, max_digits=5)),
            ],
            options={
